...
absolute path vs. relative paths (always use relative paths) \* absolute
paths are easier, relative path requires you to know the starting point
\* R give you a starting point - your file folder \* relative paths is
table, anybody downloarding the file can use it
...
whawt about `read.csv` …? \* NEVER use read.csv \* print differently,
`read_csv` will perform better decision, faster and more consistant
